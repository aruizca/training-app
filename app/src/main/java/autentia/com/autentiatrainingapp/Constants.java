...
public class Constants {
    ...
    public class ServiceURL {
        public static final String COURSE_LIST = TRAINING_SERVICE_BASE_API_URL + "/course/list";
        public static final String COURSE_SAVE = TRAINING_SERVICE_BASE_API_URL + "/course/save";
    }
}
